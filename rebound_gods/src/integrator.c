...
#include "integrator_leapfrog_ada.h"
...
void reb_integrator_part1(struct reb_simulation* r){
    switch(r->integrator){
        ...
        case REB_INTEGRATOR_LEAPFROG:
            ...
            break;
        case REB_INTEGRATOR_LEAPFROG_ADA:
            reb_integrator_leapfrog_ada_part1(r);
            break;
...
void reb_integrator_part2(struct reb_simulation* r){
    switch(r->integrator){
        ...
        case REB_INTEGRATOR_LEAPFROG:
            ...
            break;
        case REB_INTEGRATOR_LEAPFROG_ADA:
            reb_integrator_leapfrog_ada_part2(r);
            break;
        case REB_INTEGRATOR_SEI:
...
void reb_simulation_synchronize(struct reb_simulation* r){
    switch(r->integrator){
        ...
        case REB_INTEGRATOR_LEAPFROG:
            ...
            break;
        case REB_INTEGRATOR_LEAPFROG_ADA:
            reb_integrator_leapfrog_ada_synchronize(r);
            break;
        case REB_INTEGRATOR_SEI:
