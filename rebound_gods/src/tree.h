...
struct reb_treecell {
    ...
    double mvx; /**< The x velocity of the center of mass of a cell */
    double mvy; /**< The y velocity of the center of mass of a cell */
    double mvz; /**< The z velocity of the center of mass of a cell */
#ifdef QUADRUPOLE
